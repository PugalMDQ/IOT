...
import static com.mdq.v_safe.Utils.Helper.String_to_hex;
import static com.mdq.v_safe.Utils.Helper.bytesToHex;
import static com.mdq.v_safe.Utils.Helper.get_xorVal;
import static com.mdq.v_safe.Utils.Helper.getdata;
...
import com.mdq.v_safe.UI.BleActivity;
...
public class BleUtil {
    ...
    private static final String SERVICE_ID = "00000000-0000-1000-8000-00805F9B34FB"; //BLE Service Id
    ...
    private final ScanCallback leScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, @NonNull ScanResult result) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                //Log.e("DeviceName", result.getScanRecord().getDeviceName() + "");
                Log.e("DeviceName", result.getDevice().getAddress() + "");
                Toast.makeText(context, "Address: "+result.getDevice().getAddress(), Toast.LENGTH_LONG).show();
                Toast.makeText(context, "Name :"+result.getDevice().getName(), Toast.LENGTH_LONG).show();
