...
public class WifiConfigurationDataManager {
    private final String TAG = WifiConfigurationDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public WifiConfigurationDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, WifiConfigurationRequestModel wifiConfigurationRequestModel, final ResponseHandler<WifiConfigurationResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<WifiConfigurationResponseModel> userMpinCall = apiInterface.WifiConfigurationCall(url, wifiConfigurationRequestModel);
        userMpinCall.enqueue(new Callback<WifiConfigurationResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<WifiConfigurationResponseModel> call, Response<WifiConfigurationResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<WifiConfigurationResponseModel> call, Throwable t) {
