...
public class GetWifiDataManager {

    private final String TAG = GetWifiDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public GetWifiDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, String Auth, GetWifiRequestModel getWifiRequestModel, final ResponseHandler<GetWifiResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GetWifiResponseModel> userMpinCall = apiInterface.GetWifiCall(url, Auth,getWifiRequestModel);
        userMpinCall.enqueue(new Callback<GetWifiResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GetWifiResponseModel> call, Response<GetWifiResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GetWifiResponseModel> call, Throwable t) {
