...
public class MacIDStatusUpdateDataManager {
    private final String TAG = MacIDStatusUpdateDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public MacIDStatusUpdateDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, MacIDStatusRequestModel macIDStatusRequestModel, final ResponseHandler<MacIDStatusResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<MacIDStatusResponseModel> MacIDStatusCall = apiInterface.MacIDStatusCall(url, macIDStatusRequestModel);
        MacIDStatusCall.enqueue(new Callback<MacIDStatusResponseModel>() {
            /**
             * @param call
             * @param response
             ...
             */
            @Override
            public void onResponse(Call<MacIDStatusResponseModel> call, Response<MacIDStatusResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<MacIDStatusResponseModel> call, Throwable t) {
