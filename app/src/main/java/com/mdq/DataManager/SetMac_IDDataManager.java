...
public class SetMac_IDDataManager {
    private final String TAG = SetMac_IDDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public SetMac_IDDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, GenerateSetMAc_IDRequestModel generateSetMAc_idRequestModel, final ResponseHandler<GenerateSetMac_IDResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GenerateSetMac_IDResponseModel> userMpinCall = apiInterface.SetMAc_IDCall(url, generateSetMAc_idRequestModel);
        userMpinCall.enqueue(new Callback<GenerateSetMac_IDResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateSetMac_IDResponseModel> call, Response<GenerateSetMac_IDResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GenerateSetMac_IDResponseModel> call, Throwable t) {
