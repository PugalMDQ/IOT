...
public class GenerateOTPDataManager {
    private final String TAG = GenerateOTPDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public GenerateOTPDataManager(Context context) {
    ...
    public void callEnqueue(String url, GenerateOTPRequestModel generateOTPRequestModel, final ResponseHandler<GenerateOTPResponseModel> dataresponse) {
        ...
        Call<GenerateOTPResponseModel> userMpinCall = apiInterface.generateOTPall(url, generateOTPRequestModel);
        userMpinCall.enqueue(new Callback<GenerateOTPResponseModel>() {
