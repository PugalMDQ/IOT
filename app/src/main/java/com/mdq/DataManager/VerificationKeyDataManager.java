...
public class VerificationKeyDataManager {
    private final String TAG = VerificationKeyDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public VerificationKeyDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url, GenerateVerificationKeyRequestModel generateVerificationKeyResponseModel, final ResponseHandler<GenerateVerificationKeyResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GenerateVerificationKeyResponseModel> userMpinCall = apiInterface.generateVerificationCall(url, generateVerificationKeyResponseModel);
        userMpinCall.enqueue(new Callback<GenerateVerificationKeyResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateVerificationKeyResponseModel> call, Response<GenerateVerificationKeyResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GenerateVerificationKeyResponseModel> call, Throwable t) {
