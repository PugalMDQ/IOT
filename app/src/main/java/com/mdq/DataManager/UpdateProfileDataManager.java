...
public class UpdateProfileDataManager {
    ...
    public void callEnqueue(String url, String Auth, UpdateProfileRequestModel updateProfileRequestModel, final ResponseHandler<UpdateProfileResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<UpdateProfileResponseModel> userMpinCall = apiInterface.UpdateProfile(url, Auth,updateProfileRequestModel);
        userMpinCall.enqueue(new Callback<UpdateProfileResponseModel>() {
