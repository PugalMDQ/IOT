...
public class GetLockerStatusDataManager {

    private final String TAG = GetLockerStatusDataManager.class.getSimpleName();
    private ApiInterface apiInterface;
    Context context;

    public GetLockerStatusDataManager(Context context) {
        this.context = context;
        this.apiInterface = getApp().getRetrofitInterface();
    }

    public void callEnqueue(String url,String Auth, GetLockerStatusRequestModel getLockerStatusRequestModel, final ResponseHandler<GetLockerStatusResponseModel> dataresponse) {

        //calling the generatePostLoginCall methode from call apiInterface
        Call<GetLockerStatusResponseModel> userMpinCall = apiInterface.getLockerStatusCall(url,Auth, getLockerStatusRequestModel);
        userMpinCall.enqueue(new Callback<GetLockerStatusResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GetLockerStatusResponseModel> call, Response<GetLockerStatusResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GetLockerStatusResponseModel> call, Throwable t) {
