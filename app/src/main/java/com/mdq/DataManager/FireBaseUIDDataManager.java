...
public class FireBaseUIDDataManager {

     private final String TAG = FireBaseUIDDataManager.class.getSimpleName();
        private ApiInterface apiInterface;
        Context context;

        public FireBaseUIDDataManager(Context context) {
            this.context = context;
            this.apiInterface = getApp().getRetrofitInterface();
        }

        public void callEnqueue(String url, FireBase_UIDRequestModel fireBase_uidRequestModel, final ResponseHandler<FireBase_UIDResponseModel> dataresponse) {

            //calling the generatePostLoginCall methode from call apiInterface
            Call<FireBase_UIDResponseModel> userMpinCall = apiInterface.FireBase_UID(url, fireBase_uidRequestModel);
            userMpinCall.enqueue(new Callback<FireBase_UIDResponseModel>() {
                 ...
                 */
                @Override
                public void onResponse(Call<FireBase_UIDResponseModel> call, Response<FireBase_UIDResponseModel> response) {
                    /**
                 ...
                 */
                @Override
                public void onFailure(Call<FireBase_UIDResponseModel> call, Throwable t) {
